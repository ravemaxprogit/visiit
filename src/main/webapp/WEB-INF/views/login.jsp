...
<form name="loginForm" action="login" novalidate id="loginFrm">
    <div class="login-div">
        ...
        <div class="login-body">
            ...
            <div align="center" style="width:306px; min-height:100px;">
                <br></br>
                <input  id="userName" name="userName" placeholder="Enter your username" data-ng-model="login.username" type="text" data-validator="required" data-valid-method="watch" data-required-error-message="Enter your username" autofocus="autofocus">
                <input  type="password" id="password" name="passWord" placeholder="Enter your password" data-ng-model="login.password" data-validator="required" data-valid-method="watch" data-required-error-message="Enter your password">
                </div>
            ...
            <div align="center">
                <input type="button" value="Forget Password" class="btn btn-danger" data-ng-click='showForgetPwd();'/>
                <input type="button" value="Registration" class="btn btn-danger" data-ng-click='showRegistration();'/>
            </div>
        </div>
    </div>
    </form>
...
//	window.location.href = ctx+"/forgetPassword1";
//}
